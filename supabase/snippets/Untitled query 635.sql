...
BEGIN
  ...
  -----------------------------------------------------------------------------
  -- B. ÉQUIPEMENTS ÉNERGÉTIQUES (Avec INSEE + Latitude/Longitude)
  -----------------------------------------------------------------------------
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'app' AND table_name = 'energy_assets') THEN
    ...
    VALUES 
      (v_asset_ep1_id, v_org_main_id, 'Armoire EP - Centre Ville', 'Eclairage Public', '69123', 45.7675, 4.8336),
      (v_asset_ep2_id, v_org_main_id, 'Poste HT/BT - Zone Industrielle', 'Eclairage Public', '69123', 45.7500, 4.8500),
      ...
      (v_asset_pv1_id, v_org_main_id, 'Centrale Solaire - Gymnase Municipal', 'Photovoltaïque', '69029', 45.7333, 4.9117)
  ...
  -- 1. SURCHARGE (4+ Tickets) : Lucas Moreau (5 Tickets) -> BADGE ROUGE 🔴
  ...
  -- 2. NORMAL (1-3 Tickets) : Sophie Lefebvre (2 Tickets) -> BADGE VERT 🟢
  INSERT INTO app.tickets_maintenance (organization_id, asset_id, title, description, status, priority, assigned_contact_id)
  VALUES 
  ...
  -- 3. NORMAL (1-3 Tickets) : Camille Rousseau (1 Ticket) -> BADGE VERT 🟢
  INSERT INTO app.tickets_maintenance (organization_id, asset_id, title, description, status, priority, assigned_contact_id)
  VALUES 
  ...
  -- 4. NORMAL (1-3 Tickets) : Maxime Gautier (3 Tickets) -> BADGE VERT 🟢
  INSERT INTO app.tickets_maintenance (organization_id, asset_id, title, description, status, priority, assigned_contact_id)
  VALUES 
