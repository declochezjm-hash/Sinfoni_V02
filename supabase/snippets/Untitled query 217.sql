-- 1. On nettoie les contraintes de validation
...
-- 5. Dashboard Widgets (Sans la colonne "title")
INSERT INTO app.dashboard_widgets (organization_id, user_id, widget_key, config, created_at)
VALUES 
  ('00000000-0000-0000-0000-000000000001', 'a1a1a1a1-a1a1-a1a1-a1a1-a1a1a1a1a1a1', 'stats_overview', '{"total_projects": 2, "active_tasks": 5}', NOW())
