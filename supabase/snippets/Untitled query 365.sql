...
-- 4. Projets (Avec de vrais UUID hexadécimaux valides)
INSERT INTO app.projects (id, organization_id, title, status, description, created_at)
VALUES 
  ('01111111-1111-1111-1111-111111111111', '00000000-0000-0000-0000-000000000001', 'Affaire - Rénovation Centre Ville', 'active', 'Projet de déploiement réseau et infrastructure.', NOW()),
  ('02222222-2222-2222-2222-222222222222', '00000000-0000-0000-0000-000000000001', 'Affaire - Zone Industrielle Nord', 'pending', 'Audit de raccordement fibre optique.', NOW())
ON CONFLICT (id) DO NOTHING;
