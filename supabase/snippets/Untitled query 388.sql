...
-- 2. On lie des utilisateurs avec des rôles compatibles (ici 'ADMINISTRATOR' / 'USER')
-- Si votre contrainte bloque encore, essayez d'enlever la colonne role de l'insert pour laisser le DEFAULT
INSERT INTO app.users (id, organization_id, name, email, role, created_at)
VALUES 
  ('a1a1a1a1-a1a1-a1a1-a1a1-a1a1a1a1a1a1', '00000000-0000-0000-0000-000000000001', 'Admin Local', 'admin@default.local', 'ADMINISTRATOR', NOW()),
