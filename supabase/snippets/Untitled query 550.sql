...
DECLARE
  ...
  v_dgs_id   uuid := 'c1000000-0000-0000-0000-000000000001'; -- Valérie (DGS)
  v_dst_id   uuid := 'c1000000-0000-0000-0000-000000000002'; -- Alexandre (DST)
  v_ca1_id   uuid := 'c1000000-0000-0000-0000-000000000003'; -- Camille (Chargée Éclairage)
  v_ca2_id   uuid := 'c1000000-0000-0000-0000-000000000004'; -- Thomas (Chargé IRVE)
  v_tech1_id uuid := 'c1000000-0000-0000-0000-000000000005'; -- Lucas (Tech Éclairage - Surcharge)
  v_tech2_id uuid := 'c1000000-0000-0000-0000-000000000006'; -- Sophie (Tech IRVE - Normal)
  v_tech3_id uuid := 'c1000000-0000-0000-0000-000000000007'; -- Maxime (Tech Polyvalent - Normal)
  v_elu_id   uuid := 'c1000000-0000-0000-0000-000000000008'; -- Jean-Pierre (Élu)
...
BEGIN
  ...
  -----------------------------------------------------------------------------
  -- B. ÉQUIPEMENTS ENERGÉTIQUES (ASSETS avec commune_insee_code)
  -----------------------------------------------------------------------------
  IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'app' AND table_name = 'energy_assets') THEN
    INSERT INTO app.energy_assets (id, organization_id, name, type, commune_insee_code)
    VALUES 
      (v_asset_ep1_id, v_org_main_id, 'Armoire EP - Centre Ville', 'Eclairage Public', '69123'),
      (v_asset_ep2_id, v_org_main_id, 'Poste HT/BT - Zone Industrielle', 'Eclairage Public', '69123'),
      (v_asset_irve1_id, v_org_main_id, 'Station IRVE - Place du Marché', 'IRVE', '69266'),
      (v_asset_irve2_id, v_org_main_id, 'Borne Rapide 50kW - Gare', 'IRVE', '69266'),
      (v_asset_pv1_id, v_org_main_id, 'Centrale Solaires - Gymnase Municipal', 'Photovoltaïque', '69029')
  ...
  -----------------------------------------------------------------------------
  -- D. TICKETS DE MAINTENANCE & WORKLOAD TIERS
  -----------------------------------------------------------------------------
  
  -- 1. CAS SURCHARGE (4+ Tickets) : Lucas Moreau (5 Tickets) -> BADGE ROUGE 🔴
  ...
  VALUES 
    ...
    (v_org_main_id, v_asset_ep2_id, 'Remplacement mat endommagé', 'Choc véhicule léger sur mât N°12.', 'open', 'high', v_tech1_id),
  ...
  -- 2. CAS NORMAL (1-3 Tickets) : Sophie Lefebvre (2 Tickets) -> BADGE VERT 🟢
  INSERT INTO app.tickets_maintenance (organization_id, asset_id, title, description, status, priority, assigned_contact_id)
  VALUES 
  ...
  -- 3. CAS NORMAL (1-3 Tickets) : Camille Rousseau (1 Ticket) -> BADGE VERT 🟢
  INSERT INTO app.tickets_maintenance (organization_id, asset_id, title, description, status, priority, assigned_contact_id)
  VALUES 
  ...
  -- 4. CAS NORMAL (1-3 Tickets) : Maxime Gautier (3 Tickets) -> BADGE VERT 🟢
  INSERT INTO app.tickets_maintenance (organization_id, asset_id, title, description, status, priority, assigned_contact_id)
  VALUES 
    (v_org_main_id, v_asset_ep1_id, 'Nettoyage des crosse et verres', 'Entretien préventif trimestriel.', 'open', 'low', v_tech3_id),
  ...
  -- 5. TICKETS EN ATTENTE D'ASSIGNATION (Backlog général)
  INSERT INTO app.tickets_maintenance (organization_id, asset_id, title, description, status, priority, assigned_contact_id)
  VALUES 
