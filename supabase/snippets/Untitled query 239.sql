...
-- 4. Projets (Avec la colonne reference ajoutée)
INSERT INTO app.projects (id, organization_id, reference, title, status, description, created_at)
VALUES 
  ('01111111-1111-1111-1111-111111111111', '00000000-0000-0000-0000-000000000001', 'AFF-2026-001', 'Affaire - Rénovation Centre Ville', 'active', 'Projet de déploiement réseau et infrastructure.', NOW()),
  ('02222222-2222-2222-2222-222222222222', '00000000-0000-0000-0000-000000000001', 'AFF-2026-002', 'Affaire - Zone Industrielle Nord', 'pending', 'Audit de raccordement fibre optique.', NOW())
ON CONFLICT (id) DO NOTHING;
